...
public class ItemUtils {
	...
	public enum DisplayName{
		...
		GRAY_WOOL(35, 7, "grey_wool", "grey", "gray"),
		...
		INK_SACK(351, 0, "ink_sac", "black_dye"),
		RED_DYE(351, 1, "rose_red_dye", "rose_red"),
		GREEN_DYE(351, 2, "cactus_green_dye", "catus_green"),
		COCOA_BEANS(351, 3, "brown_dye"),
		LAPIS_LAZULI(351, 4, "blue_dye"),
		PURPLE_DYE(351, 5),
		CYAN_DYE(351, 6),
		...
		MAGENTA_DYE(351, 13),
		ORANGE_DYE(351, 14),
		BONEMEAL(351, 15, "bonemeal_dye", "white_dye"),
